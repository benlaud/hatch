...
function hatch_wrap_before() { do_action('hatch_wrap_before'); }
function hatch_header_before() { do_action('hatch_header_before'); }
function hatch_header_inside() { do_action('hatch_header_inside'); }
function hatch_header_after() { do_action('hatch_header_after'); }
